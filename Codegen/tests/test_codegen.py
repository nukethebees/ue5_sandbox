...
void append_from(Other const& other) {
    ...
    def test_fixed_soa_arrays_generate_multiple_owners_with_one_size_each(self) -> None:
        soa = SoAStruct(
            SoAStructNames("FData"),
            (tarray_member("values", "int32"), tarray_member("weights", "float")),
            fixed_storage_name="TDataFixedStorage",
            fixed_arrays=(FixedSoAArray("TFirstFixedData"), FixedSoAArray("TSecondFixedData")),
        )
    ...
    def test_fixed_soa_storage_recurses_without_nested_sizes(self) -> None:
        child = SoAStruct(
            ...
            fixed_storage_name="TChildFixedStorage",
        )
        parent = SoAStruct(
            ...
            fixed_storage_name="TParentFixedStorage",
            fixed_arrays=(FixedSoAArray("TParentFixedArray"),),
        )
    ...
    def test_fixed_soa_arrays_require_storage_and_unique_names(self) -> None:
        with self.assertRaisesRegex(ValueError, "require a fixed storage name"):
            SoAStruct(
                SoAStructNames("FData"),
                (tarray_member("values", "int32"),),
                fixed_arrays=(FixedSoAArray("TFixedData"),),
            )
        with self.assertRaisesRegex(ValueError, "must not contain duplicates"):
            SoAStruct(
                ...
                (tarray_member("values", "int32"),),
                fixed_storage_name="TDataFixedStorage",
                fixed_arrays=(FixedSoAArray("TFixedData"), FixedSoAArray("TFixedData")),
            )
