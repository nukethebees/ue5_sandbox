...
TEST(Json, LoadsTypedSoaManifest) {
    ...
    files.write(
        "types.json",
        R"({"types":{"handle":{"spelling":"FHandle","header":"Handle.h","pass_by":"value","operations":{"remove_at_swap":"remove_at_swap","set_element":{"function":"set","pass_by":"value"}}}}})");
    files.write(
        "modules.json",
    ...
    files.write("manifest.json",
                R"({"schema_version":10,"types":"types.json","modules":["modules.json"]})");
...
TEST(Json, RejectsDuplicateFieldsInsteadOfSilentlyOverwritingThem) {
    TemporaryManifest files;
    files.write("manifest.json",
                R"({"schema_version":10,"schema_version":10,"types":"types.json","modules":[]})");
    ...
    files.write("manifest.json", R"({"schema_version":10,"types":"types.json","modules":[]})");
...
TEST(Json, ReportsMissingRequiredFields) {
    TemporaryManifest files;
    files.write("types.json", R"({"types":{}})");
    files.write("manifest.json", R"({"schema_version":10,"types":"types.json"})");
...
TEST(Json, ReportsMissingReferencedDocuments) {
    ...
    files.write("types.json", R"({"types":{}})");
    files.write("manifest.json",
                R"({"schema_version":10,"types":"types.json","modules":["missing.json"]})");
