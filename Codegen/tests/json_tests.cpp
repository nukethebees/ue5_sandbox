...
TEST(Json, LoadsTypedSoaManifest) {
    ...
    files.write("manifest.json",
                R"({"schema_version":9,"types":"types.json","modules":["modules.json"]})");
...
TEST(Json, RejectsDuplicateFieldsInsteadOfSilentlyOverwritingThem) {
    TemporaryManifest files;
    files.write("manifest.json",
                R"({"schema_version":9,"schema_version":9,"types":"types.json","modules":[]})");
    ...
    files.write("manifest.json", R"({"schema_version":9,"types":"types.json","modules":[]})");
...
TEST(Json, ReportsMissingRequiredFields) {
    TemporaryManifest files;
    files.write("types.json", R"({"types":{}})");
    files.write("manifest.json", R"({"schema_version":9,"types":"types.json"})");
...
TEST(Json, ReportsMissingReferencedDocuments) {
    ...
    files.write("types.json", R"({"types":{}})");
    files.write("manifest.json",
                R"({"schema_version":9,"types":"types.json","modules":["missing.json"]})");
