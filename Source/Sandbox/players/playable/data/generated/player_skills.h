...
inline constexpr std::array<int32, 5> attributes_values{{
...
inline constexpr std::array<int32, 1> tech_values{{
...
inline constexpr std::array<int32, 1> weapon_values{{
...
struct FPlayerSkills {
    GENERATED_BODY()
  public:
    using Getter = int32 (FPlayerSkills::*)() const;
    using Setter = void (FPlayerSkills::*)(int32);
