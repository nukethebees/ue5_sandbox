...
#include "TestUniformFieldFly1.generated.h"

class UStaticMeshComponent;

class ATestUniformField;

// This version doesn't warp back when oob
// It instead heads towards the middle when choosing a new direction

UCLASS()
class ATestUniformFieldFly1 : public AActor {
    GENERATED_BODY()
  public:
    ATestUniformFieldFly1();
