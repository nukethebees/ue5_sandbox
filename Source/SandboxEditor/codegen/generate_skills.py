...
"""
            ...
            self.output_file += f"inline constexpr std::array<{self.skill_type}, {n}> {lname}_values{{{{\n"
            first = True
...
"""
        ...
        self.output_file += f"""    using Getter = {self.skill_type} ({self.player_skills_struct_typename}::*)() const;
    using Setter = void ({self.player_skills_struct_typename}::*)({self.skill_type});
