...
struct BenchmarkResult {
    ...
    std::int32_t steady_state_fighters{};
    std::int32_t minimum_measured_fighters{};
    std::int32_t maximum_measured_fighters{};
    std::int32_t fighter_spawns_during_measurement{};
    std::int32_t lasers_spawned_during_measurement{};
    std::int32_t standby_fighters{};
    std::int32_t moving_fighters{};
    std::int32_t attacking_fighters{};
