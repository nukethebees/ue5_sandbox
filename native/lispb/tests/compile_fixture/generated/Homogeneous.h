...
struct FValuesf {
    ...
    template <typename TFunc> auto apply_arrays(TFunc&& func) -> decltype(auto) { return std::forward<TFunc>(func)(xs, ys); }
    template <typename TFunc> auto apply_arrays(TFunc&& func) const -> decltype(auto) { return std::forward<TFunc>(func)(xs, ys); }
    auto num() const -> size_type { return xs.Num(); }
    ...
    void set(size_type const index, FVector2f const& value) {
        set(index, value.X, value.Y);
    }
    auto add(FVector2f const& value) -> size_type {
        return add(value.X, value.Y);
    }
    void set(size_type const index, FPoint2f const& value) {
        set(index, value.X, value.Y);
    }
    auto add(FPoint2f const& value) -> size_type {
        return add(value.X, value.Y);
    }
    auto reset() -> void {
        xs.Reset();
...
struct FScalari {
    ...
    auto get_const_view() const -> ConstView { return ConstView{values}; }
    auto get_const_view(size_type const offset, size_type const count) const -> ConstView { return get_const_view().slice(offset, count); }
    template <typename TFunc> auto apply_arrays(TFunc&& func) -> decltype(auto) { return std::forward<TFunc>(func)(values); }
    template <typename TFunc> auto apply_arrays(TFunc&& func) const -> decltype(auto) { return std::forward<TFunc>(func)(values); }
    auto num() const -> size_type { return values.Num(); }
    void validate_array_sizes() const {
    ...
    void set(size_type const index, value_type const v) {
        values[index] = v;
    }
