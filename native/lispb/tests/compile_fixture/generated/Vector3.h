...
struct FVectors3fView {
    ...
    void set(int32 const i, FVector3f const value) const {
        set(i, value.X, value.Y, value.Z);
    }
...
struct FVectors3f {
    ...
    void set(int32 const i, FVector3f const value) {
        set(i, value.X, value.Y, value.Z);
    }
...
struct TVectors3Storage {
    ...
    void copy_construct_at(int32 const index, TVectors3Storage const& other, int32 const other_index) {
...
struct TFixedVectors3 {
    ...
    auto operator=(TFixedVectors3 const&) -> TFixedVectors3&
        requires (!supports_copy_construction)
    = delete;
    auto operator=(TFixedVectors3&& other) noexcept(supports_nothrow_move_construction) -> TFixedVectors3&
        requires supports_move_construction
    {
        if (this != std::addressof(other)) {
            reset();
