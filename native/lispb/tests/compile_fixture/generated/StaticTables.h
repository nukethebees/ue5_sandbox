...
struct FStaticTableFixture {
    ...
    auto get_row(int32 const index) const -> FRow { return FRow{ids[index], weights[index]}; }

    TStaticArray<int32, num_rows> ids{};
    TStaticArray<float, num_rows> weights{};
};

struct FStaticGroupFixture {
    static constexpr int32 num_rows{3};
    ...
    auto apply_arrays(this auto&& self, TFunc&& func) -> decltype(auto) {
        return std::forward<TFunc>(func)(
            self.min_xs, self.min_ys, self.min_zs, self.max_xs, self.max_ys, self.max_zs);
    }
