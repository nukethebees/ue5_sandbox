...
class TArray {
  public:
    ...
    void RemoveAtSwap(SizeType const index, SizeType const count, EAllowShrinking const) {
    ...
    auto operator[](SizeType const index) -> T& { return values_[static_cast<std::size_t>(index)]; }
