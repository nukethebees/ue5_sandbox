...
struct TestCapitalShipFighterSpawnQueueConstView {
    ...
    std::span<FRegistryEntityHandle const> parents;
    ...
    auto get_view() const -> TestCapitalShipFighterSpawnQueueConstView { return *this; }
    ...
    auto left(size_type const count) const -> TestCapitalShipFighterSpawnQueueConstView {
        return slice(0, count);
    }
    auto right(size_type const count) const -> TestCapitalShipFighterSpawnQueueConstView {
...
struct TestCapitalShipFighterSpawnQueueView {
    ...
    auto get_view() const -> TestCapitalShipFighterSpawnQueueView { return *this; }
    auto get_view(size_type const offset, size_type const count) const
        -> TestCapitalShipFighterSpawnQueueView {
        return slice(offset, count);
    }
    ...
    auto left(size_type const count) const -> TestCapitalShipFighterSpawnQueueView {
        return slice(0, count);
    }
    auto right(size_type const count) const -> TestCapitalShipFighterSpawnQueueView {
        return slice(num() - count, count);
    }
};
struct TestCapitalShipFighterSpawnQueue {
    using View = TestCapitalShipFighterSpawnQueueView;
    using ConstView = TestCapitalShipFighterSpawnQueueConstView;
    using size_type = std::int32_t;
    Vectors3f locations;
    ...
    ml::native_soa::Vector<FRegistryEntityHandle> parents;
    ...
    void append_from(ConstView source) {
        ...
        }
        {
            ...
            ml::native_soa::require(address < begin ||
                                    address >=
                                        begin + parents.size() * sizeof(FRegistryEntityHandle));
        }
        {
