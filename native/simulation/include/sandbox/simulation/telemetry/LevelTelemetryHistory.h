...
enum class EHistoryField : std::uint8_t {
    ActiveEntities = 0,
    ActiveEntitiesByType = static_cast<std::uint8_t>(ActiveEntities) + 1,
    ActiveEntitiesByTeamAndType = static_cast<std::uint8_t>(ActiveEntitiesByType) +
                                  (ml::simulation::telemetry::entity_type_count),
    SpawnedEntities =
        static_cast<std::uint8_t>(ActiveEntitiesByTeamAndType) +
        (ml::simulation::telemetry::team_count) * (ml::simulation::telemetry::entity_type_count),
...
struct FHistoryFieldMask {
    inline static constexpr std::int32_t field_count{
        static_cast<std::int32_t>(EHistoryField::Count)};
    ...
    [[nodiscard]] static constexpr auto index(EHistoryField const field) noexcept -> std::int32_t {
    ...
    [[nodiscard]] static constexpr auto
        ...
        return static_cast<EHistoryField>(
            static_cast<std::int32_t>(EHistoryField::ActiveEntitiesByType) + entity_type_index);
    }
    ...
    [[nodiscard]] static constexpr auto
        ...
        -> EHistoryField {
        return static_cast<EHistoryField>(
            static_cast<std::int32_t>(EHistoryField::ActiveEntitiesByTeamAndType) +
            team_index * (ml::simulation::telemetry::entity_type_count) + entity_type_index);
    }
  private:
...
struct FHistoryRowsConstView {
    ...
    std::span<ml::simulation::telemetry::EntityCounts const> active_entities_by_team_and_type;
    ...
    auto slice(size_type const offset, size_type const count) const -> FHistoryRowsConstView {
    ...
    auto get_view() const -> FHistoryRowsConstView { return *this; }
    auto get_view(size_type const offset, size_type const count) const -> FHistoryRowsConstView {
    ...
    auto left(size_type const count) const -> FHistoryRowsConstView { return slice(0, count); }
    auto right(size_type const count) const -> FHistoryRowsConstView {
...
struct FHistoryRowsView {
    ...
    std::span<ml::simulation::telemetry::EntityCounts> active_entities_by_team_and_type;
    ...
    auto slice(size_type const offset, size_type const count) const -> FHistoryRowsView {
        ml::native_soa::require(offset >= 0 && count >= 0 && offset <= num() &&
                                count <= num() - offset);
        return {
            completed_ticks.subspan(static_cast<std::size_t>(offset),
    ...
    auto get_view() const -> FHistoryRowsView { return *this; }
    auto get_view(size_type const offset, size_type const count) const -> FHistoryRowsView {
        return slice(offset, count);
    }
    auto get_const_view() const -> ConstView {
        return {
    ...
    auto left(size_type const count) const -> FHistoryRowsView { return slice(0, count); }
    auto right(size_type const count) const -> FHistoryRowsView {
        return slice(num() - count, count);
    }
    void set(size_type const index,
             ...
             ml::simulation::telemetry::EntityCounts const new_active_entities_by_team_and_type,
...
struct FHistoryRows {
    ...
    ml::native_soa::Vector<ml::simulation::telemetry::EntityCounts>
        active_entities_by_team_and_type;
    ...
    void append_from(ConstView source) {
        ...
        }
        {
            ...
            ml::native_soa::require(address < begin ||
                                    address >=
                                        begin + validity_masks.size() * sizeof(FHistoryFieldMask));
        }
        {
        ...
        }
        {
            ...
            ml::native_soa::require(
                ...
                address >= begin + active_entities_by_type.size() *
                                       sizeof(ml::simulation::telemetry::EntityTypeCounts));
        }
        {
            auto const address{
            ...
            ml::native_soa::require(
                ...
                address >= begin + active_entities_by_team_and_type.size() *
                                       sizeof(ml::simulation::telemetry::EntityCounts));
        }
        {
...
struct FHistoryRowsSingleLayout {
    ...
    inline static constexpr ColLayout<ml::simulation::telemetry::EntityTypeCounts>
        ActiveEntitiesByType{ActiveEntities};
    inline static constexpr ColLayout<ml::simulation::telemetry::EntityCounts>
  ...
  private:
    inline static constexpr auto validate_layout = []() consteval -> bool {
        ...
        static_assert(
            ml::native_soa::supported_leaf<FHistoryFieldMask>,
        ...
        static_assert(
            ...
            "copyable/copy-constructible/destructible, nothrow default-constructible object type.");
        static_assert(
            ml::native_soa::supported_leaf<ml::simulation::telemetry::EntityTypeCounts>,
            "Single-allocation leaf active_entities_by_type requires a non-cv, trivially "
            "copyable/copy-constructible/destructible, nothrow default-constructible object type.");
        static_assert(
            ml::native_soa::supported_leaf<ml::simulation::telemetry::EntityCounts>,
        ...
        static_assert(sizeof(ml::simulation::telemetry::EntityTypeCounts) <=
                      (max_allocation_size - ActiveEntitiesByType.block_offset) /
                          capacity_granularity);
        static_assert(sizeof(ml::simulation::telemetry::EntityCounts) <=
...
struct FSingleAllocationHistoryRowsStorage
    ...
    ~FSingleAllocationHistoryRowsStorage() { ml::native_soa::free(data_, allocation_alignment); }
  ...
  protected:
    ...
    struct DataPointers {
        ...
        Element<ml::simulation::telemetry::EntityCounts>* active_entities_by_team_and_type{};
  ...
  private:
    ...
    void default_construct_columns(size_type const first, size_type const count) {
        ...
        std::uninitialized_value_construct_n<ml::simulation::telemetry::EntityCounts*>(
...
struct FHistoryRowsSingleConstView : ml::native_soa::CompactViewState<true> {
    ...
    auto validity_masks() const -> std::span<FHistoryFieldMask const> {
    ...
    auto active_entities() const -> std::span<std::int32_t const> {
        return {column_data<std::int32_t>(
                    FHistoryRowsSingleLayout::ActiveEntities.offset(capacity_blocks())),
                static_cast<std::size_t>(count_)};
    }
    auto active_entities_by_type() const
        -> std::span<ml::simulation::telemetry::EntityTypeCounts const> {
        return {column_data<ml::simulation::telemetry::EntityTypeCounts>(
                    FHistoryRowsSingleLayout::ActiveEntitiesByType.offset(capacity_blocks())),
                static_cast<std::size_t>(count_)};
    }
    auto active_entities_by_team_and_type() const
        -> std::span<ml::simulation::telemetry::EntityCounts const> {
        return {
            column_data<ml::simulation::telemetry::EntityCounts>(
    ...
    auto spawned_entities() const -> std::span<std::int32_t const> {
        return {column_data<std::int32_t>(
                    FHistoryRowsSingleLayout::SpawnedEntities.offset(capacity_blocks())),
                static_cast<std::size_t>(count_)};
    }
    ...
    auto kills() const -> std::span<std::int32_t const> {
        return {
            column_data<std::int32_t>(FHistoryRowsSingleLayout::Kills.offset(capacity_blocks())),
            static_cast<std::size_t>(count_)};
    }
    ...
    auto active_lasers() const -> std::span<std::int32_t const> {
        return {column_data<std::int32_t>(
                    FHistoryRowsSingleLayout::ActiveLasers.offset(capacity_blocks())),
                static_cast<std::size_t>(count_)};
    }
    auto lasers_fired() const -> std::span<std::int32_t const> {
        return {column_data<std::int32_t>(
                    FHistoryRowsSingleLayout::LasersFired.offset(capacity_blocks())),
                static_cast<std::size_t>(count_)};
    }
    ...
    auto line_trace_count() const -> std::span<std::uint64_t const> {
        return {column_data<std::uint64_t>(
                    FHistoryRowsSingleLayout::LineTraceCount.offset(capacity_blocks())),
                static_cast<std::size_t>(count_)};
    }
    ...
    auto columns() const -> FHistoryRowsConstView {
        ...
        return FHistoryRowsConstView{
            ...
            {column_data_unchecked<std::int32_t>(
                 FHistoryRowsSingleLayout::ActiveEntities.offset(blocks)),
             static_cast<std::size_t>(count_)},
            {column_data_unchecked<ml::simulation::telemetry::EntityTypeCounts>(
                 FHistoryRowsSingleLayout::ActiveEntitiesByType.offset(blocks)),
             static_cast<std::size_t>(count_)},
            {column_data_unchecked<ml::simulation::telemetry::EntityCounts>(
                 FHistoryRowsSingleLayout::ActiveEntitiesByTeamAndType.offset(blocks)),
             static_cast<std::size_t>(count_)},
            {column_data_unchecked<std::int32_t>(
                 FHistoryRowsSingleLayout::SpawnedEntities.offset(blocks)),
             static_cast<std::size_t>(count_)},
            {column_data_unchecked<std::int32_t>(
                 FHistoryRowsSingleLayout::DestroyedEntities.offset(blocks)),
             static_cast<std::size_t>(count_)},
            {column_data_unchecked<std::int32_t>(FHistoryRowsSingleLayout::Kills.offset(blocks)),
             static_cast<std::size_t>(count_)},
            {column_data_unchecked<std::int32_t>(
                 FHistoryRowsSingleLayout::RegistrySlotCount.offset(blocks)),
             static_cast<std::size_t>(count_)},
            {column_data_unchecked<std::int32_t>(
                 FHistoryRowsSingleLayout::ActiveLasers.offset(blocks)),
             static_cast<std::size_t>(count_)},
            {column_data_unchecked<std::int32_t>(
                 FHistoryRowsSingleLayout::LasersFired.offset(blocks)),
             static_cast<std::size_t>(count_)},
            {column_data_unchecked<std::int32_t>(
            ...
            {column_data_unchecked<std::uint64_t>(
             ...
             static_cast<std::size_t>(count_)},
            {column_data_unchecked<std::uint64_t>(
                 FHistoryRowsSingleLayout::LineTraceCount.offset(blocks)),
             static_cast<std::size_t>(count_)},
            {column_data_unchecked<std::uint64_t>(
...
struct FHistoryRowsSingleView : ml::native_soa::CompactViewState<false> {
    ...
    auto validity_masks() const -> std::span<FHistoryFieldMask> {
        return {column_data<FHistoryFieldMask>(
                    FHistoryRowsSingleLayout::ValidityMasks.offset(capacity_blocks())),
                static_cast<std::size_t>(count_)};
    }
    ...
    auto active_entities_by_type() const -> std::span<ml::simulation::telemetry::EntityTypeCounts> {
        return {column_data<ml::simulation::telemetry::EntityTypeCounts>(
                    FHistoryRowsSingleLayout::ActiveEntitiesByType.offset(capacity_blocks())),
                static_cast<std::size_t>(count_)};
    }
    auto active_entities_by_team_and_type() const
        -> std::span<ml::simulation::telemetry::EntityCounts> {
        return {
            column_data<ml::simulation::telemetry::EntityCounts>(
                FHistoryRowsSingleLayout::ActiveEntitiesByTeamAndType.offset(capacity_blocks())),
            static_cast<std::size_t>(count_)};
