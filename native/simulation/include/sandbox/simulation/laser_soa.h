...
struct SpawnRequestsConstView {
    ...
    std::span<FRegistryEntityHandle const> instigator_handles;
...
struct SpawnRequestsView {
    ...
    std::span<FRegistryEntityHandle> instigator_handles;
...
struct SpawnRequests {
    ...
    ml::native_soa::Vector<FRegistryEntityHandle> instigator_handles;
