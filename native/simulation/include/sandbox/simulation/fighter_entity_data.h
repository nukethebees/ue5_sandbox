...
struct FighterEntityDataConstView {
    ...
    std::span<FRegistryEntityHandle const> parent_handles;
...
struct FighterEntityDataView {
    ...
    using ConstView = FighterEntityDataConstView;
    using size_type = std::int32_t;
    std::span<FRegistryEntityHandle> entity_handles;
    ...
    std::span<FRegistryEntityHandle> parent_handles;
...
struct FighterEntityData {
    ...
    using ConstView = FighterEntityDataConstView;
    using size_type = std::int32_t;
    ml::native_soa::Vector<FRegistryEntityHandle> entity_handles;
    ...
    ml::native_soa::Vector<FRegistryEntityHandle> parent_handles;
    ...
    ml::native_soa::Vector<FRegistryEntityHandle> target_handles;
