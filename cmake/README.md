...
After clearing the worktree's old build directories and running generators, use
`cmake --workflow --preset task-start` once to build native and developer-tool test binaries.
...
ordinary native/game validation excludes the C# suite.
