...
INCLUDE_MAPPINGS: List[Tuple[str, str]] = [
    ...
    (r'#include "Sandbox/widgets/HealthWidget\.h"',
     r'#include "Sandbox/ui/widgets/umg/HealthWidget.h"'),
    (r'#include "Sandbox/widgets/HealthStationWidget\.h"',
     r'#include "Sandbox/ui/widgets/umg/HealthStationWidget.h"'),
    (r'#include "Sandbox/widgets/MainHUDWidget\.h"',
     r'#include "Sandbox/ui/widgets/umg/MainHUDWidget.h"'),
    (r'#include "Sandbox/widgets/MainMenu2Widget\.h"',
     r'#include "Sandbox/ui/widgets/umg/MainMenu2Widget.h"'),
    (r'#include "Sandbox/widgets/LevelSelect2Widget\.h"',
     r'#include "Sandbox/ui/widgets/umg/LevelSelect2Widget.h"'),
    (r'#include "Sandbox/widgets/LoadLevelButtonWidget\.h"',
     r'#include "Sandbox/ui/widgets/umg/LoadLevelButtonWidget.h"'),
    ...
    (r'#include "Sandbox/widgets/options_menu/OptionsWidget\.h"',
     r'#include "Sandbox/ui/widgets/umg/options_menu/OptionsWidget.h"'),
    (r'#include "Sandbox/widgets/options_menu/VideoSettingRowWidget\.h"',
     r'#include "Sandbox/ui/widgets/umg/options_menu/VideoSettingRowWidget.h"'),
    (r'#include "Sandbox/widgets/options_menu/VisualsOptionsWidget\.h"',
     r'#include "Sandbox/ui/widgets/umg/options_menu/VisualsOptionsWidget.h"'),
    (r'#include "Sandbox/widgets/options_menu/AudioOptionsWidget\.h"',
     r'#include "Sandbox/ui/widgets/umg/options_menu/AudioOptionsWidget.h"'),
    (r'#include "Sandbox/widgets/options_menu/GameplayOptionsWidget\.h"',
     r'#include "Sandbox/ui/widgets/umg/options_menu/GameplayOptionsWidget.h"'),
    (r'#include "Sandbox/widgets/options_menu/ControlsOptionsWidget\.h"',
     r'#include "Sandbox/ui/widgets/umg/options_menu/ControlsOptionsWidget.h"'),
    ...
    (r'#include "Sandbox/widgets/CommonMenuDelegates\.h"',
     r'#include "Sandbox/ui/widgets/umg/CommonMenuDelegates.h"'),
]
