...
struct UHeatmapRDGShowcaseBuilder {
    ...
    explicit UHeatmapRDGShowcaseBuilder(ThisClass& self)
        : self_{self} {}

    auto BuildSizeButton(auto&& label, auto&& on_clicked) {
        return
#line 8 "HeatmapRDGShowcase.lispb"
            SNew(SButton).Text(label).OnClicked(on_clicked);
    }

    auto RebuildWidget(auto&& size_32_button,
                       auto&& size_64_button,
                       auto&& size_128_button,
                       auto&& size_256_button,
                       auto&& size_512_button,
                       auto&& heatmap_preview) {
...
#line 23 "HeatmapRDGShowcase.lispb"
            SNew(SExperimentPanel)
                ...
                .Description(NSLOCTEXT(
                    "HeatmapRDG",
                    "Description",
                    "Each update uploads one dense scalar grid and draws one Slate image."))
                .Controls()
                    [SNew(SVerticalBox) +
                         ...
                         [SNew(SLabeledRow)
                              .Label(NSLOCTEXT(
                                  ...
                                  [SNew(SHorizontalBox) +
                                   ...
                                   SandboxUI::Slate::hbox_auto_slot()[std::forward<
                                       decltype(size_512_button)>(size_512_button)]]] +
                                  ...
                                  [SNew(SHorizontalBox) +
                                   SandboxUI::Slate::hbox_auto_slot(FMargin{button_padding})
                                       [SNew(SButton)
                                            ...
                                            .OnClicked_UObject(&self_, &ThisClass::show_hotspots)] +
                                   SandboxUI::Slate::hbox_auto_slot()
                                       [SNew(SButton)
                                            .Text(NSLOCTEXT(
                                                "HeatmapRDG", "Gradient", "Gradient + checker"))
                                            .OnClicked_UObject(&self_,
                                                               &ThisClass::show_gradient)]]] +
                     SandboxUI::Slate::vbox_auto_slot()
                         [SNew(SExperimentBenchmark)
                              .ButtonText(NSLOCTEXT("HeatmapRDG",
                                                    "RunBenchmark",
