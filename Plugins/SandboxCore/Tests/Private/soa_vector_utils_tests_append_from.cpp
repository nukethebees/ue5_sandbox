...
TEST_CASE("SandboxCore.SoaVectorUtils.append_from.Vectors") {
    ...
    auto const to_append{ml::make_vectors3f(TArray<FVector3f>{{4.0f, 5.0f, 6.0f}, {7.0f, 8.0f, 9.0f}})};

    ml::append_from(vectors, to_append);

    auto const expected{ml::make_vectors3f(TArray<FVector3f>{{1.0f, 2.0f, 3.0f}, {4.0f, 5.0f, 6.0f}, {7.0f, 8.0f, 9.0f}})};
...
TEST_CASE("SandboxCore.SoaVectorUtils.append_from.View") {
    ...
    auto const expected{ml::make_vectors3f(TArray<FVector3f>{{1.0f, 2.0f, 3.0f}, {7.0f, 8.0f, 9.0f}})};
