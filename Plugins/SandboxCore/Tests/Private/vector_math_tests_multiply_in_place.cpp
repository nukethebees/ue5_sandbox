...
TEST_CASE("SandboxCore.Math.multiply_in_place.Scalar") {
    ...
    auto const expected{
        ml::make_vectors3f(TArray<FVector3f>{{4.0f, -8.0f, 0.0f}, {-6.0f, 10.0f, -12.0f}})};
...
TEST_CASE("SandboxCore.Math.multiply_in_place.SharedFactors") {
    ...
    auto const expected{
        ml::make_vectors3f(TArray<FVector3f>{{0.0f, 0.0f, 0.0f}, {-2.0f, -5.0f, -8.0f}, {6.0f, 12.0f, 18.0f}})};
...
TEST_CASE("SandboxCore.Math.multiply_in_place.ComponentFactors") {
    ...
    auto const expected{
        ml::make_vectors3f(TArray<FVector3f>{{2.0f, -3.0f, 2.5f}, {6.0f, 0.0f, -12.0f}})};
