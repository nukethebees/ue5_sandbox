...
TEST_CASE("SandboxCore.Math.add_scaled_in_place.Zero") {
    ...
    ml::kernel::add_scaled_in_place(
        dst_x.GetData(), dst_y.GetData(), dst_z.GetData(), src_x.GetData(), src_y.GetData(), src_z.GetData(), 0.0f, dst_x.Num());
...
TEST_CASE("SandboxCore.Math.add_scaled_in_place.Two") {
    ...
    ml::kernel::add_scaled_in_place(
        dst_x.GetData(), dst_y.GetData(), dst_z.GetData(), src_x.GetData(), src_y.GetData(), src_z.GetData(), 2.0f, dst_x.Num());
...
TEST_CASE("SandboxCore.Math.add_scaled_in_place.SharedScaleArray") {
    ...
    ml::kernel::add_scaled_in_place(
        dst_x.GetData(), dst_y.GetData(), dst_z.GetData(), a_x.GetData(), a_y.GetData(), a_z.GetData(), b.GetData(), 0.5f, dst_x.Num());
