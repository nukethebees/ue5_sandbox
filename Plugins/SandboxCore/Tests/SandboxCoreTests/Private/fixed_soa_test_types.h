...
struct FTestFixedChildConstView {
    ...
    auto apply_arrays(this auto&& self, TFunc&& func) -> decltype(auto) {
        return std::forward<TFunc>(func)(self.names, self.references);
    }
...
struct FTestFixedChild {
    ...
    auto apply_array_pairs(this Self&& self, Other&& other, TFunc&& func) -> decltype(auto) {
        return std::forward<TFunc>(func)(self.names, other.names, self.references, other.references);
    }
...
struct TTestFixedChildStorage {
    ...
    auto get_const_view(int32 const offset, int32 const count) const -> ConstView {
        return ConstView{TConstArrayView<FString>{names_.data() + offset, count},
                         TConstArrayView<TSharedPtr<int32>>{references_.data() + offset, count}};
    }
...
struct FTestFixedRowsConstView {
    ...
    template <typename TFunc>
    auto apply_arrays(this auto&& self, TFunc&& func) -> decltype(auto) {
        return std::forward<TFunc>(func)(self.children, self.ids);
    }
...
struct FTestFixedRows {
    ...
    template <typename Self, typename Other, typename TFunc>
    auto apply_array_pairs(this Self&& self, Other&& other, TFunc&& func) -> decltype(auto) {
        return std::forward<TFunc>(func)(self.children, other.children, self.ids, other.ids);
    }
...
struct TTestFixedRowsArray {
    ...
    inline static constexpr bool supports_copy_construction{
        std::is_copy_constructible_v<FString> && std::is_copy_constructible_v<TSharedPtr<int32>> && std::is_copy_constructible_v<int32>};
    inline static constexpr bool supports_move_construction{
        std::is_move_constructible_v<FString> && std::is_move_constructible_v<TSharedPtr<int32>> && std::is_move_constructible_v<int32>};
    inline static constexpr bool supports_nothrow_move_construction{std::is_nothrow_move_constructible_v<FString> &&
                                                                    std::is_nothrow_move_constructible_v<TSharedPtr<int32>> &&
                                                                    std::is_nothrow_move_constructible_v<int32>};
    inline static constexpr bool supports_default_construction{std::is_default_constructible_v<FString> &&
    ...
    inline static constexpr bool supports_uninitialised_storage{
        std::is_trivially_copyable_v<FString> && std::is_trivially_destructible_v<FString> &&
        std::is_trivially_copyable_v<TSharedPtr<int32>> && std::is_trivially_destructible_v<TSharedPtr<int32>> &&
        std::is_trivially_copyable_v<int32> && std::is_trivially_destructible_v<int32>};
    template <typename TArg0, typename TArg1, typename TArg2>
    inline static constexpr bool supports_element_construction_from{std::is_constructible_v<FString, TArg0&&> &&
    ...
    auto emplace_back(TArg0&& new_children_names, TArg1&& new_children_references, TArg2&& new_ids) -> size_type {
        ...
        storage_.construct_at(
            index, std::forward<TArg0>(new_children_names), std::forward<TArg1>(new_children_references), std::forward<TArg2>(new_ids));
        ++size_;
        return index;
    }
    template <typename TArg0, typename TArg1, typename TArg2>
        requires supports_element_construction_from<TArg0, TArg1, TArg2>
    auto add(TArg0&& new_children_names, TArg1&& new_children_references, TArg2&& new_ids) -> size_type {
        return emplace_back(
            std::forward<TArg0>(new_children_names), std::forward<TArg1>(new_children_references), std::forward<TArg2>(new_ids));
    }
    ...
    template <typename Other>
    void copy_elements(size_type const dst_index, Other const& other, size_type const source_index, size_type const count) {
        check(dst_index >= 0);
        check(source_index >= 0);
        check(count >= 0);
