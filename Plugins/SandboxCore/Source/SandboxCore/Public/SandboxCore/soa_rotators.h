...
struct TRotatorsView {
    ...
    auto slice(size_type const offset, size_type const count) const -> TRotatorsView {
        return TRotatorsView{
            pitches.Slice(offset, count), yaws.Slice(offset, count), rolls.Slice(offset, count)};
    }
    ...
    void
        set(size_type const index, value_type const p, value_type const y, value_type const r) const
