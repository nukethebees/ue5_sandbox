...
struct SANDBOXCORE_API FVectors2dView {
    ...
    void set(int32 const i, double const x, double const y) const {
        xs[i] = x;
        ys[i] = y;
    }

    void set(int32 const i, FVector2d const value) const {
...
struct SANDBOXCORE_API FVectors2d {
    ...
    void set(int32 const i, FVector2d const value) {
        set(i, value.X, value.Y);
    }
