...
struct TVectors3fFixedStorage {
    ...
    void copy_construct_at(int32 const index,
                           TVectors3fFixedStorage const& other,
    ...
    void move_construct_at(int32 const index,
                           TVectors3fFixedStorage& other,
                           int32 const other_index) {
    ...
    void move_assign_at(int32 const dst_index,
                        TVectors3fFixedStorage& other,
                        int32 const source_index) {
...
struct TFixedVectors3f {
    ...
    auto operator=(TFixedVectors3f const&) -> TFixedVectors3f&
        requires (!supports_copy_construction)
    = delete;
    auto operator=(TFixedVectors3f&& other) noexcept(supports_nothrow_move_construction)
        -> TFixedVectors3f&
        requires supports_move_construction
    {
        if (this != std::addressof(other)) {
