...
namespace {
auto make_native_view(FVectors3f::ConstView const values) -> ml::Vector3fSoAConstView {
    return {values.xs.GetData(), values.ys.GetData(), values.zs.GetData(), values.num()};
}
