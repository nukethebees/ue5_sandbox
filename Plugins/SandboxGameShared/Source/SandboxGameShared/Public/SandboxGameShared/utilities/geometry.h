...
auto SANDBOXGAMESHARED_API get_norm_vector_to_actor(AActor& actor, FVector point) -> FVector;
auto SANDBOXGAMESHARED_API get_angle_to_actor(AActor& actor, FVector point) -> double;

// 2 segments = 3 lines
auto SANDBOXGAMESHARED_API subdivide_arc_into_segments(float starting_angle_deg,
                                             float arc_deg,
