...
namespace ml {
auto SANDBOXGAMESHARED_API get_abs_angle_from_fwd_vector(FVector standing_pt,
                                                         FVector fwd,
                                                         AActor const& target)
    -> double;

auto SANDBOXGAMESHARED_API find_actors_within_cone(AActor const& actor,
...
auto SANDBOXGAMESHARED_API get_centre_actor_in_fov(AActor const& actor,
                                                    TArrayView<AActor*> options) -> AActor*;
