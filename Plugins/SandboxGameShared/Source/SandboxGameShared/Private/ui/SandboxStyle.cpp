...
#include "SandboxGameShared/ui/font_scaling.h"
...
void SandboxStyle::initialize_text_styles() {
    auto const widget_font_size{scale_font_to_umg(32)};
    ...
    auto const body_font_size{scale_font_to_umg(16)};
    ...
    auto const label_font_size{scale_font_to_umg(14)};
    FTextBlockStyle label_style{};
    label_style.SetFont(FSlateFontInfo(FCoreStyle::GetDefaultFontStyle("Regular", label_font_size)));
