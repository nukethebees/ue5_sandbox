...
#include "SandboxMaterialExprs.h"

#define LOCTEXT_NAMESPACE "FSandboxMaterialExprsModule"

void FSandboxMaterialExprsModule::StartupModule() {
...
void FSandboxMaterialExprsModule::ShutdownModule() {
...
IMPLEMENT_MODULE(FSandboxMaterialExprsModule, SandboxMaterialExprs)
