...
#include "ShooterGame/players/MyPlayerControllerCache.h"
#include "ShooterGame/players/MyPlayerControllerInputActions.h"
...
UCLASS()
class SHOOTERGAME_API AMyPlayerController
    : public APlayerController
    , public ml::LogMsgMixin<"MyPlayerController", LogShooterGameController>
