...
#include "ShooterGame/players/CameraConfig.h"
#include "ShooterGame/players/HumanoidMovement.h"
#include "ShooterGame/players/MaxSpeedChangeListener.h"
...
UCLASS()
class SHOOTERGAME_API AMyCharacter
    : public ACharacter
    , public ml::LogMsgMixin<"MyCharacter", LogShooterGameCharacter>
