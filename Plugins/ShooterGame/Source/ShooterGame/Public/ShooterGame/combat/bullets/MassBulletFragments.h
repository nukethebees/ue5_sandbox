...
USTRUCT()
struct SHOOTERGAME_API FMassBulletTransformFragment : public FMassFragment {
    GENERATED_BODY()
...
USTRUCT()
struct SHOOTERGAME_API FMassBulletVelocityFragment : public FMassFragment {
    GENERATED_BODY()
...
USTRUCT()
struct SHOOTERGAME_API FMassBulletLastPositionFragment : public FMassFragment {
    GENERATED_BODY()
...
USTRUCT()
struct SHOOTERGAME_API FMassBulletDamageFragment : public FMassFragment {
    GENERATED_BODY()
...
USTRUCT()
struct SHOOTERGAME_API FMassBulletHitInfoFragment : public FMassFragment {
    GENERATED_BODY()
...
USTRUCT()
struct SHOOTERGAME_API FMassBulletStateFragment : public FMassFragment {
    GENERATED_BODY()
...
USTRUCT()
struct SHOOTERGAME_API FMassBulletImpactEffectFragment : public FMassConstSharedFragment {
    GENERATED_BODY()
...
USTRUCT()
struct SHOOTERGAME_API FMassBulletVisualizationActorFragment : public FMassConstSharedFragment {
    GENERATED_BODY()
...
USTRUCT()
struct SHOOTERGAME_API FMassBulletDataFragment : public FMassConstSharedFragment {
    GENERATED_BODY()
...
USTRUCT()
struct SHOOTERGAME_API FMassBulletSourceFragment : public FMassFragment {
    GENERATED_BODY()
