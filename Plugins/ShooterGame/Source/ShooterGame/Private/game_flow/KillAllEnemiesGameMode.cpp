#include "ShooterGame/game_flow/KillAllEnemiesGameMode.h"
...
void AKillAllEnemiesGameMode::BeginPlay() {
    ...
    UE_LOG(LogShooterGameGameMode, Verbose, TEXT("Registering actors."));
    using T = ATestEnemy;
    ...
    UE_LOG(LogShooterGameGameMode, Verbose, TEXT("Registered %d actors."), enemies_left);
}
