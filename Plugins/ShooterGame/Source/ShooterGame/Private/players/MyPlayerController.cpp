#include "ShooterGame/players/MyPlayerController.h"
...
#include "ShooterGame/players/JetpackComponent.h"
#include "ShooterGame/players/WarpComponent.h"
#include "ShooterGame/ui/hud/AmmoHUDWidget.h"
#include "ShooterGame/ui/hud/ItemDescriptionHUDWidget.h"
#include "ShooterGame/ui/hud/MainHUDWidget.h"
#include "ShooterGame/ui/hud/TargetOverlayHUDWidget.h"
#include "ShooterGame/ui/in_game_menu/InGamePlayerMenu.h"
...
void AMyPlayerController::possess_target() {
    ...
    if (hit) {
        if (auto* character{Cast<AMyCharacter>(hit_result.GetActor())}) {
            if (character == pawn) {
                UE_LOG(LogShooterGameController, Warning, TEXT("Possess raycast hit self."));
                return;
            }

            UE_LOG(LogShooterGameController, Verbose, TEXT("Possess raycast hit new character."));
            Possess(character);
        }
    }
}
