#include "ShooterGame/players/behaviour_tree/BTTask_AttackEnemy.h"
...
#include "ShooterGame/players/CombatActor.h"
#include "ShooterGame/players/navigation.h"
...
EBTNodeResult::Type UBTTask_AttackEnemy::ExecuteTask(UBehaviorTreeComponent& owner_comp,
    ...
    if (attack_succeeded) {
        ...
        UE_LOG(LogShooterGameAI, Verbose, TEXT("Attack failed.\n"));
