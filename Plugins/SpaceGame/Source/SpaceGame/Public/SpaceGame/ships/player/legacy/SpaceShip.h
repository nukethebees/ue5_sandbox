...
class ASpaceShip
  ...
  public:
    ...
    SPACEGAME_API void turn(FVector2D direction);
    SPACEGAME_API void start_boost();
    SPACEGAME_API void stop_boost();
    SPACEGAME_API void start_brake();
    SPACEGAME_API void stop_brake();
    auto get_velocity() const { return velocity; }
    auto get_speed() const { return get_velocity().Size(); }
    SPACEGAME_API void roll(float direction);
    SPACEGAME_API void barrel_roll(float direction);
    ...
    SPACEGAME_API void add_health(int32 added_health);
    auto get_health_info() const -> FShipHealth { return health->get_health_info(); }
    SPACEGAME_API void add_gold_ring();
    ...
    SPACEGAME_API auto get_middle_socket() const -> FTransform;
