...
#include "SpaceGame/ships/fighters/TestCapitalShipFighterOrder.h"
...
struct SPACEGAME_API TestCapitalShipFighterOrderQueueConstView {
...
struct SPACEGAME_API TestCapitalShipFighterOrderQueueView {
    using View = TestCapitalShipFighterOrderQueueView;
    using ConstView = TestCapitalShipFighterOrderQueueConstView;
...
struct SPACEGAME_API TestCapitalShipFighterOrderQueue {
    using View = TestCapitalShipFighterOrderQueueView;
    using ConstView = TestCapitalShipFighterOrderQueueConstView;
