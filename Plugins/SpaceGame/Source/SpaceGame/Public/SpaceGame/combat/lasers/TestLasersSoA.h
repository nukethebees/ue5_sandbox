...
struct SPACEGAME_API SpawnRequestsConstView {
...
struct SPACEGAME_API SpawnRequestsView {
    using View = SpawnRequestsView;
    using ConstView = SpawnRequestsConstView;
...
struct SPACEGAME_API SpawnRequests {
    using View = SpawnRequestsView;
    using ConstView = SpawnRequestsConstView;
...
struct SPACEGAME_API EntitiesConstView {
...
struct SPACEGAME_API EntitiesView {
    using View = EntitiesView;
    using ConstView = EntitiesConstView;
...
struct SPACEGAME_API HitDetailsConstView {
...
struct SPACEGAME_API HitDetailsView {
    using View = HitDetailsView;
    using ConstView = HitDetailsConstView;
