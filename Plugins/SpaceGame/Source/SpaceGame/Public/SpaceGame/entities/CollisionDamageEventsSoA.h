...
struct SPACEGAME_API UnresolvedCollisionDamageEventsConstView {
...
struct SPACEGAME_API UnresolvedCollisionDamageEventsView {
    using View = UnresolvedCollisionDamageEventsView;
    using ConstView = UnresolvedCollisionDamageEventsConstView;
...
struct SPACEGAME_API CollisionDamageEventsConstView {
...
struct SPACEGAME_API CollisionDamageEventsView {
    using View = CollisionDamageEventsView;
    using ConstView = CollisionDamageEventsConstView;
