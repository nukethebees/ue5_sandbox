...
SPACEGAME_API auto serialize_level_telemetry_run(FLevelTelemetryReport const& record) -> FString;
...
SPACEGAME_API auto write_level_telemetry_run(FLevelTelemetryReport const& record,
