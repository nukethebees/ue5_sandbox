...
namespace ml::ioj {
namespace level_outcome_row_widget {
...
void ULevelOutcomeRowWidget::set_selected(bool const is_selected) {
    ...
    row_button->SetBackgroundColor(is_selected ? level_outcome_row_widget::selected_colour
                                               : level_outcome_row_widget::inactive_colour);
}
