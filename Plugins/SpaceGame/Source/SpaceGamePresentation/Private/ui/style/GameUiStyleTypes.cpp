...
auto get_game_text_style_name(EGameTextStyle const value) -> TCHAR const* {
    ...
    ensureMsgf(false, TEXT("Unhandled EGameTextStyle value: %lld"), static_cast<int64>(value));
...
auto get_game_button_style_name(EGameButtonStyle const value) -> TCHAR const* {
    ...
    ensureMsgf(false, TEXT("Unhandled EGameButtonStyle value: %lld"), static_cast<int64>(value));
...
auto get_game_ui_icon_name(EGameUiIcon const value) -> TCHAR const* {
    ...
    ensureMsgf(false, TEXT("Unhandled EGameUiIcon value: %lld"), static_cast<int64>(value));
