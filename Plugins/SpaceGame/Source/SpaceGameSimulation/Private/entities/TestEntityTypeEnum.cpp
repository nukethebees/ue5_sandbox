...
auto get_test_entity_type_name(ETestEntityType const value) -> TCHAR const* {
    ...
    ensureMsgf(false, TEXT("Unhandled ETestEntityType value: %lld"), static_cast<int64>(value));
...
auto get_test_entity_type_serialized_name(ETestEntityType const value) -> TCHAR const* {
    ...
    ensureMsgf(
        false, TEXT("Unhandled serialized ETestEntityType value: %lld"), static_cast<int64>(value));
    return TEXT("<invalid ETestEntityType>");
}
