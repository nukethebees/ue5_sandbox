...
#include "SpaceGameSimulation/entities/CollisionDamageEventsSoA.h"
...
void UnresolvedCollisionDamageEvents::apply_permutation(TArrayView<int32> indices) {
...
void CollisionDamageEvents::apply_permutation(TArrayView<int32> indices) {
    validate_array_sizes();
    check(indices.Num() == num());
    ml::apply_permutation(damage_amounts, indices);
    ml::apply_permutation(actor_components, indices);
