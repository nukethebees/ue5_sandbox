...
struct SPACEGAMESIMULATION_API FEntityCellDataConstView {
...
struct SPACEGAMESIMULATION_API FEntityCellDataView {
    using View = FEntityCellDataView;
    using ConstView = FEntityCellDataConstView;
...
struct SPACEGAMESIMULATION_API FEntityCellData {
    using View = FEntityCellDataView;
    using ConstView = FEntityCellDataConstView;
