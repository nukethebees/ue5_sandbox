...
struct SPACEGAMESIMULATION_API TestCapitalShipFighterOrderQueueConstView {
...
struct SPACEGAMESIMULATION_API TestCapitalShipFighterOrderQueueView {
    using View = TestCapitalShipFighterOrderQueueView;
    using ConstView = TestCapitalShipFighterOrderQueueConstView;
...
struct SPACEGAMESIMULATION_API TestCapitalShipFighterOrderQueue {
    using View = TestCapitalShipFighterOrderQueueView;
    using ConstView = TestCapitalShipFighterOrderQueueConstView;
