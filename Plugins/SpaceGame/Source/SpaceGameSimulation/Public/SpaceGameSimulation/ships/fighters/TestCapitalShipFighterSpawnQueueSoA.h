...
struct SPACEGAMESIMULATION_API TestCapitalShipFighterSpawnQueueConstView {
...
struct SPACEGAMESIMULATION_API TestCapitalShipFighterSpawnQueueView {
    using View = TestCapitalShipFighterSpawnQueueView;
    using ConstView = TestCapitalShipFighterSpawnQueueConstView;
...
struct SPACEGAMESIMULATION_API TestCapitalShipFighterSpawnQueue {
    using View = TestCapitalShipFighterSpawnQueueView;
    using ConstView = TestCapitalShipFighterSpawnQueueConstView;
