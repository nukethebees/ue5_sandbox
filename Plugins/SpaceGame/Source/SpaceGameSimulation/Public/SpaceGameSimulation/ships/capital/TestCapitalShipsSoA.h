...
struct SPACEGAMESIMULATION_API FighterReassignmentConstView {
...
struct SPACEGAMESIMULATION_API FighterReassignmentView {
    using View = FighterReassignmentView;
    using ConstView = FighterReassignmentConstView;
...
struct SPACEGAMESIMULATION_API FighterReassignment {
    using View = FighterReassignmentView;
    using ConstView = FighterReassignmentConstView;
