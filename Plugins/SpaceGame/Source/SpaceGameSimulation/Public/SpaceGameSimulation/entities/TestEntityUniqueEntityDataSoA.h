...
struct SPACEGAMESIMULATION_API TestEntityUniqueEntityDataConstView {
...
struct SPACEGAMESIMULATION_API TestEntityUniqueEntityDataView {
    using View = TestEntityUniqueEntityDataView;
    using ConstView = TestEntityUniqueEntityDataConstView;
...
struct SPACEGAMESIMULATION_API TestEntityUniqueEntityData {
    using View = TestEntityUniqueEntityDataView;
    using ConstView = TestEntityUniqueEntityDataConstView;
