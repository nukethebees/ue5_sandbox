...
struct SPACEGAMESIMULATION_API DirectDamageEventsConstView {
...
struct SPACEGAMESIMULATION_API DirectDamageEventsView {
    using View = DirectDamageEventsView;
    using ConstView = DirectDamageEventsConstView;
...
struct SPACEGAMESIMULATION_API DirectDamageEvents {
    using View = DirectDamageEventsView;
    using ConstView = DirectDamageEventsConstView;
