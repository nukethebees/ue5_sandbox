...
struct SPACEGAMESIMULATION_API EntityDeathInfoConstView {
...
struct SPACEGAMESIMULATION_API EntityDeathInfoView {
    using View = EntityDeathInfoView;
    using ConstView = EntityDeathInfoConstView;
...
struct SPACEGAMESIMULATION_API EntityDeathInfo {
    using View = EntityDeathInfoView;
    using ConstView = EntityDeathInfoConstView;
