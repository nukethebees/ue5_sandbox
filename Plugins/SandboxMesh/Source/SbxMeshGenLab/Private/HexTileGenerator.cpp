...
void add_triangle(FSbxMeshData& mesh_data,
...
auto generate_hex_tile(FSbxHexTileParameters const& parameters) -> FSbxMeshData {
    ...
    constexpr int32 face_triangle_count{side_count * 2};
    constexpr int32 surface_quad_count{side_count * 3};
