...
[[nodiscard]] auto get_generated_asset_filename(FName asset_name,
                                                FString const& relative_directory = {}) -> FString;
[[nodiscard]] auto get_generated_asset_object_path(FName asset_name,
                                                   FString const& relative_directory = {})
    -> FString;
